...
public class HealthInsurancePrivateTest extends BaseTest {
    ...
    private final String HEALTH_INSURANCE_BUTTON_NAME = "Добровольное медицинское страхование";
    ...
    public void Test(UserData userData) {
        ...
        companiesPage.ClickHealthInsuranceButton(HEALTH_INSURANCE_BUTTON_NAME);
